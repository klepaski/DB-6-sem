...
1. Уст GDAL
2. setx PROJ_LIB
3. (.shx, .shp, .prj, .dbf) в один каталог
5. в папке GDAL cmd: ogr2ogr -update -f MSSQLSpatial -lco “GEOM_TYPE=geography”
 -a_srs "EPSG:4326" "MSSQL:server=[имя сервера];database=[имя базы данных];
 trusted_connection=yes" "D:\3\БД\4\relief"
*/
